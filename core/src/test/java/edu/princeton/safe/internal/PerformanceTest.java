...
public class PerformanceTest {
    ...
    public void testElapsedTime() throws Exception {
        ...
        AnnotationParser annotationParser = new TabDelimitedAnnotationParser("src/test/resources/hoepfner_movva_2014_hop_known.txt");
        ...
        time("Neighborhoods",
         ...
         FileProgressReporter("neighborhood.binary.txt");
//        DefaultProgressReporter progressReporter = new DefaultProgressReporter();
        ...
        NeighborhoodScoringMethod scoringMethod = new RandomizedMemberScoringMethod(annotationProvider, generator,
         ...
         ProgressReporter progressReporter2 = new
